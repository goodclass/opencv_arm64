static PyObject* pyopencv_cv_AKAZE_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|OiifiiO:AKAZE_create", (char**)keywords, &pyobj_descriptor_type, &descriptor_size, &descriptor_channels, &threshold, &nOctaves, &nOctaveLayers, &pyobj_diffusivity) &&
...
static PyObject* pyopencv_cv_AgastFeatureDetector_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|ibO:AgastFeatureDetector_create", (char**)keywords, &threshold, &nonmaxSuppression, &pyobj_type) &&
...
static PyObject* pyopencv_cv_DISOpticalFlow_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|i:DISOpticalFlow_create", (char**)keywords, &preset) )
    {
...
static PyObject* pyopencv_cv_KAZE_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|bbfiiO:KAZE_create", (char**)keywords, &extended, &upright, &threshold, &nOctaves, &nOctaveLayers, &pyobj_diffusivity) &&
        pyopencv_to(pyobj_diffusivity, diffusivity, ArgInfo("diffusivity", 0)) )
    {
...
static PyObject* pyopencv_cv_ORB_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|ifiiiiOii:ORB_create", (char**)keywords, &nfeatures, &scaleFactor, &nlevels, &edgeThreshold, &firstLevel, &WTA_K, &pyobj_scoreType, &patchSize, &fastThreshold) &&
...
static PyObject* pyopencv_cv_PSNR(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|d:PSNR", (char**)keywords, &pyobj_src1, &pyobj_src2, &R) &&
...
static PyObject* pyopencv_cv_calibrateCameraRO(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOiOO|OOOiO:calibrateCameraRO", (char**)keywords, &pyobj_objectPoints, &pyobj_imagePoints, &pyobj_imageSize, &iFixedPoint, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_rvecs, &pyobj_tvecs, &pyobj_newObjPoints, &flags, &pyobj_criteria) &&
        pyopencv_to(pyobj_objectPoints, objectPoints, ArgInfo("objectPoints", 0)) &&
        pyopencv_to(pyobj_imagePoints, imagePoints, ArgInfo("imagePoints", 0)) &&
        pyopencv_to(pyobj_imageSize, imageSize, ArgInfo("imageSize", 0)) &&
        pyopencv_to(pyobj_cameraMatrix, cameraMatrix, ArgInfo("cameraMatrix", 1)) &&
...
static PyObject* pyopencv_cv_calibrateCameraROExtended(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOOiOO|OOOOOOOiO:calibrateCameraROExtended", (char**)keywords, &pyobj_objectPoints, &pyobj_imagePoints, &pyobj_imageSize, &iFixedPoint, &pyobj_cameraMatrix, &pyobj_distCoeffs, &pyobj_rvecs, &pyobj_tvecs, &pyobj_newObjPoints, &pyobj_stdDeviationsIntrinsics, &pyobj_stdDeviationsExtrinsics, &pyobj_stdDeviationsObjPoints, &pyobj_perViewErrors, &flags, &pyobj_criteria) &&
        pyopencv_to(pyobj_objectPoints, objectPoints, ArgInfo("objectPoints", 0)) &&
        pyopencv_to(pyobj_imagePoints, imagePoints, ArgInfo("imagePoints", 0)) &&
        pyopencv_to(pyobj_imageSize, imageSize, ArgInfo("imageSize", 0)) &&
        pyopencv_to(pyobj_cameraMatrix, cameraMatrix, ArgInfo("cameraMatrix", 1)) &&
...
static PyObject* pyopencv_cv_findChessboardCornersSB(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "image", "patternSize", "corners", "flags", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|Oi:findChessboardCornersSB", (char**)keywords, &pyobj_image, &pyobj_patternSize, &pyobj_corners, &flags) &&
        pyopencv_to(pyobj_image, image, ArgInfo("image", 0)) &&
        pyopencv_to(pyobj_patternSize, patternSize, ArgInfo("patternSize", 0)) &&
        pyopencv_to(pyobj_corners, corners, ArgInfo("corners", 1)) )
    {
...
static PyObject* pyopencv_cv_getPerspectiveTransform(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OO|i:getPerspectiveTransform", (char**)keywords, &pyobj_src, &pyobj_dst, &solveMethod) &&
        pyopencv_to(pyobj_src, src, ArgInfo("src", 0)) &&
        pyopencv_to(pyobj_dst, dst, ArgInfo("dst", 0)) )
    {
...
static PyObject* pyopencv_cv_rectangle(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|iii:rectangle", (char**)keywords, &pyobj_img, &pyobj_rec, &pyobj_color, &thickness, &lineType, &shift) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 1)) &&
...
static PyObject* pyopencv_cv_cuda_TargetArchs_has(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "ii:TargetArchs_has", (char**)keywords, &major, &minor) )
    {
...
static PyObject* pyopencv_cv_cuda_TargetArchs_hasBin(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "major", "minor", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "ii:TargetArchs_hasBin", (char**)keywords, &major, &minor) )
    {
...
static PyObject* pyopencv_cv_cuda_TargetArchs_hasEqualOrGreater(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "major", "minor", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "ii:TargetArchs_hasEqualOrGreater", (char**)keywords, &major, &minor) )
    {
...
static PyObject* pyopencv_cv_cuda_TargetArchs_hasEqualOrGreaterBin(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "major", "minor", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "ii:TargetArchs_hasEqualOrGreaterBin", (char**)keywords, &major, &minor) )
    {
...
static PyObject* pyopencv_cv_cuda_TargetArchs_hasEqualOrGreaterPtx(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "major", "minor", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "ii:TargetArchs_hasEqualOrGreaterPtx", (char**)keywords, &major, &minor) )
    {
...
static PyObject* pyopencv_cv_cuda_TargetArchs_hasEqualOrLessPtx(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "major", "minor", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "ii:TargetArchs_hasEqualOrLessPtx", (char**)keywords, &major, &minor) )
    {
...
static PyObject* pyopencv_cv_cuda_TargetArchs_hasPtx(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "major", "minor", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "ii:TargetArchs_hasPtx", (char**)keywords, &major, &minor) )
    {
...
static PyObject* pyopencv_cv_cuda_createContinuous(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "iii|O:createContinuous", (char**)keywords, &rows, &cols, &type, &pyobj_arr) &&
...
static PyObject* pyopencv_cv_cuda_ensureSizeIsEnough(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "rows", "cols", "type", "arr", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "iii|O:ensureSizeIsEnough", (char**)keywords, &rows, &cols, &type, &pyobj_arr) &&
        pyopencv_to(pyobj_arr, arr, ArgInfo("arr", 1)) )
    {
...
static PyObject* pyopencv_cv_cuda_printCudaDeviceInfo(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "i:printCudaDeviceInfo", (char**)keywords, &device) )
    {
...
static PyObject* pyopencv_cv_cuda_printShortCudaDeviceInfo(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "device", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "i:printShortCudaDeviceInfo", (char**)keywords, &device) )
    {
...
static PyObject* pyopencv_cv_cuda_setBufferPoolConfig(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "iIi:setBufferPoolConfig", (char**)keywords, &deviceId, &stackSize, &stackCount) )
    {
...
static PyObject* pyopencv_cv_cuda_setBufferPoolUsage(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "b:setBufferPoolUsage", (char**)keywords, &on) )
    {
...
static PyObject* pyopencv_cv_cuda_setDevice(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "device", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "i:setDevice", (char**)keywords, &device) )
    {
...
static PyObject* pyopencv_cv_detail_BestOf2NearestMatcher_create(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "|bfii:BestOf2NearestMatcher_create", (char**)keywords, &try_use_gpu, &match_conf, &num_matches_thresh1, &num_matches_thresh2) )
    {
...
static PyObject* pyopencv_cv_detail_Blender_createDefault(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "i|b:Blender_createDefault", (char**)keywords, &type, &try_gpu) )
    {
...
static PyObject* pyopencv_cv_detail_ExposureCompensator_createDefault(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "i:ExposureCompensator_createDefault", (char**)keywords, &type) )
    {
...
static PyObject* pyopencv_cv_detail_SeamFinder_createDefault(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "type", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "i:SeamFinder_createDefault", (char**)keywords, &type) )
    {
...
static PyObject* pyopencv_cv_detail_Timelapser_createDefault(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "type", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "i:Timelapser_createDefault", (char**)keywords, &type) )
    {
...
static PyObject* pyopencv_cv_detail_createLaplacePyr(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OiO:createLaplacePyr", (char**)keywords, &pyobj_img, &num_levels, &pyobj_pyr) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 0)) &&
...
static PyObject* pyopencv_cv_detail_createLaplacePyrGpu(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "img", "num_levels", "pyr", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OiO:createLaplacePyrGpu", (char**)keywords, &pyobj_img, &num_levels, &pyobj_pyr) &&
        pyopencv_to(pyobj_img, img, ArgInfo("img", 0)) &&
        pyopencv_to(pyobj_pyr, pyr, ArgInfo("pyr", 1)) )
    {
...
static PyObject* pyopencv_cv_detail_createWeightMap(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OfO:createWeightMap", (char**)keywords, &pyobj_mask, &sharpness, &pyobj_weight) &&
        pyopencv_to(pyobj_mask, mask, ArgInfo("mask", 0)) &&
...
static PyObject* pyopencv_cv_detail_focalsFromHomography(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "Oddbb:focalsFromHomography", (char**)keywords, &pyobj_H, &f0, &f1, &f0_ok, &f1_ok) &&
        pyopencv_to(pyobj_H, H, ArgInfo("H", 0)) )
    {
...
static PyObject* pyopencv_cv_detail_leaveBiggestComponent(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOf:leaveBiggestComponent", (char**)keywords, &pyobj_features, &pyobj_pairwise_matches, &conf_threshold) &&
...
static PyObject* pyopencv_cv_detail_matchesGraphAsString(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOf:matchesGraphAsString", (char**)keywords, &pyobj_pathes, &pyobj_pairwise_matches, &conf_threshold) &&
...
static PyObject* pyopencv_cv_detail_selectRandomSubset(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    if( PyArg_ParseTupleAndKeywords(args, kw, "iiO:selectRandomSubset", (char**)keywords, &count, &size, &pyobj_subset) &&
